...
me    =    نشان دادن مقام شما
sudoers    =    نشان دادن سودوها
support    =    دریافت لینک ساپورت
tagall [msg]    =    ارسال پیام همگانی
time    =    دریافت ساعت
voice [text]    =    تبدیل متن به صدا
keep calm [text]    =    ساخت لوگو کیپ کالم
sticker [text]    =    تبدیل متن به استیکر
🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹🔹
⭐️مدیریت یک فرد:⭐️
